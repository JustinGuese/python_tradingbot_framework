...
# Daily option-chain capture (utils/option_capture.py): SPY and QQQ for index
# vol, then the 50 largest SP100 members by market cap on 2026-09-26. Frozen,
# like SP100: a history is only useful if the names in it stay the same, so a
# stock that later drops out of the top 50 keeps being captured. Add names at
# the end rather than re-ranking.
OPTION_CAPTURE_AS_OF = "2026-09-26"
OPTION_CAPTURE_UNIVERSE: tuple[str, ...] = (
    "SPY",
    "QQQ",
    "NVDA",
    "AAPL",
